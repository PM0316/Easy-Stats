// Easy Stats.cpp : This file contains the 'main' function. Program execution begins and ends there.


/*
    This App is about using a collection (list) of integers and allowing the user
    to select options from a menu to perform operations on the list.

    Your App will display a menu options to the user as follows:
